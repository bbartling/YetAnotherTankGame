...
def make_tank(label, body_material, size, barrel_length, boss=False):
    ...
    cube("LeftTrack", (-1.9 * size, 0, 0.75 * size), (0.42 * size, 2.55 * size, 0.62 * size), DARK, model_root, 0.16)
    cube("RightTrack", (1.9 * size, 0, 0.75 * size), (0.42 * size, 2.55 * size, 0.62 * size), DARK, model_root, 0.16)
    cube("LeftTrack_Damaged", (-1.95 * size, 0.1, 0.65 * size), (0.4 * size, 2.2 * size, 0.42 * size), ORANGE, model_root, 0.1, (0.12, 0.04, 0.08))
    cube("RightTrack_Damaged", (1.95 * size, 0.1, 0.65 * size), (0.4 * size, 2.2 * size, 0.42 * size), ORANGE, model_root, 0.1, (-0.1, -0.04, -0.08))
